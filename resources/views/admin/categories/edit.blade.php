...
<div class="py-12 bg-white">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-cyan-50 border-2 border-black">
            <div class="px-6 py-8">
                <h3 class="text-lg leading-6 font-light text-black">Edit Kategori</h3>
                ...
                <form method="POST" action="{{ route('admin.categories.update', $category) }}" class="mt-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="3"
                                  class="mt-1 block w-full border-2 border-black px-3 py-2 bg-white text-black font-light focus:outline-none focus:border-black">{{ old('description', $category->description) }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
